import { BookOpen, Brain, Code, ArrowRight, Clock, Users, Star } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">আমাদের কোর্স</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            বিনামূল্যে শিখুন প্রোগ্রামিং এবং মেশিন লার্নিং - সহজ বাংলায়, ধাপে ধাপে
          </p>
        </div>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-blue-50 to-blue-100">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <h4 className="font-semibold text-gray-900">কোর্সের বিষয়বস্তু:</h4>
