...
3. **ML এ সব ডেটা ভেক্টর/ম্যাট্রিক্স আকারে থাকে**
    ...
    quiz: {
      ...
      correct: 0,
      explanation:
        "ভেক্টর হলো সংখ্যার একটি তালিকা বা অ্যারে। যেমন [১, ২, ৩] একটি ভেক্টর।",
    },
    glossary: [
      { term: "ভেক্টর", definition: "সংখ্যার একটি তালিকা বা অ্যারে" },
      {
        term: "ম্যাট্রিক্স",
        definition: "ভেক্টরের একটি সংগ্রহ, সারি এবং কলামে সাজানো",
      },
      {
        term: "NumPy",
        definition:
          "Python এর একটি লাইব্রেরি যা ভেক্টর এবং ম্যাট্রিক্স নিয়ে কাজ করে",
      },
    ],
  },
};
                  ...
                  <div
                    dangerouslySetInnerHTML={{
                      __html: lesson.content
                        ...
                        .replace(
                          /```python\n([\s\S]*?)\n```/g,
                          '<pre class="bg-gray-100 p-4 rounded-lg overflow-x-auto"><code class="text-sm">$1</code></pre>'
                        )
                        .replace(
                          /```\n([\s\S]*?)\n```/g,
                          '<pre class="bg-gray-100 p-4 rounded-lg overflow-x-auto"><code class="text-sm">$1</code></pre>'
            ...
            <Card className='bg-green-50 border-green-200'>
              ...
              <CardContent>
                <p className='text-sm text-green-700 mb-3'>
                  আপনার পরিবারের সদস্যদের বয়স নিয়ে একটি ভেক্টর তৈরি করুন এবং
                  গড় বয়স বের করুন।
                </p>
                <Button
                  size='sm'
