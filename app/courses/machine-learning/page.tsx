...
const courseStructure = [
  {
    ...
    lessons: [
      ...
      {
        id: 2,
        title: "ক্যালকুলাস - ডেরিভেটিভ এবং গ্রেডিয়েন্ট",
        completed: false,
      },
      {
        id: 3,
        title: "পরিসংখ্যান - গড়, মিডিয়ান, স্ট্যান্ডার্ড ডেভিয়েশন",
        completed: false,
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: 7,
        title: "NumPy - অ্যারে এবং ম্যাথমেটিক্যাল অপারেশন",
        completed: false,
      },
  ...
  },
  {
    ...
    lessons: [
      {
        id: 10,
        title: "ডেটা ক্লিনিং - মিসিং ভ্যালু হ্যান্ডলিং",
        completed: false,
      },
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            <div className='lg:col-span-2'>
              ...
              <p className='text-lg text-gray-700 mb-6'>
                এই কোর্সে আপনি শিখবেন কিভাবে মেশিন লার্নিং কাজ করে, কিভাবে ডেটা
                থেকে প্যাটার্ন খুঁজে বের করতে হয় এবং কিভাবে AI মডেল তৈরি করতে
                হয়। সবকিছু সহজ বাংলায়, বাস্তব উদাহরণ দিয়ে।
              </p>
                        ...
                        {section.lessons.map((lesson) => (
                          <div
                            ...
                            <Button
                              ...
                              <Link
                                href={`/courses/machine-learning/lessons/${lesson.id}`}>
                                {lesson.completed
                                  ? "পুনরায় দেখুন"
                                  : "শুরু করুন"}
                              </Link>
